...
<div class="aluno-form">
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <div class="row">
            <?= $form->field($model, 'conceitoExameProf', ['options' => ['class' => 'col-md-2']])->dropDownlist(['1' => 'Aprovado', '2' => 'Reprovado'], ['prompt' => 'Selecione um Conceito...'])->label("<font color='#FF0000'>*</font> <b>Conceito Obtido:</b>");
            ?>
        </div>
