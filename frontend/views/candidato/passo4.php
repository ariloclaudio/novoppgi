...
<div class="candidato-index">
	...
	<p align="center"><font size="3"><b>Inscrição realizada com sucesso!!!</b></font></p>
   	...
   	<br /><p align="right"><font size="2" style="line-height: 150%">Ass: Coordenação do PPGI/UFAM</font></p><br />
		...
		<a target="resource window" href="index.php?option=com_inscricaoppgi&task=viewpdf&doc=pp&id=<?php echo $candidato['id'];?>">
		...
		<a target="resource window" href="index.php?option=com_inscricaoppgi&task=viewpdf&doc=cp&id=<?php echo $candidato['id'];?>">
		...
		<a target="resource window" href="index.php?option=com_inscricaoppgi&task=viewpdf&doc=ce&id=<?php echo $candidato['id'];?>">
